<div class="space-y-0 text-slate-800 font-sans bg-white">
    ...
    <!-- 1. TOP FADE-OFF HERO SLIDER SECTION -->
    <section id="hero" 
             x-data="{ 
                 currentSlide: 0, 
                 totalSlides: 3,
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
                <div class="max-w-xl space-y-6">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-2">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefab Portable House')"
                           class="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-[#FF8B02] text-white font-extrabold px-8 py-3.5 rounded-full shadow-lg transition-all text-sm transform hover:-translate-y-0.5">
                            Learn More
                            <svg class="w-4 h-4 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        </a>
                        <a href="#categories" 
                           class="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-800 font-bold px-7 py-3.5 rounded-full border border-slate-300 shadow-sm text-sm">
                            View Range
                        </a>
                    </div>
        ...
        <div x-show="currentSlide === 1" 
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
                <div class="max-w-xl space-y-6">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-2">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefabricated Site Office')"
                           class="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-[#FF8B02] text-white font-extrabold px-8 py-3.5 rounded-full shadow-lg transition-all text-sm transform hover:-translate-y-0.5">
                            Learn More
                            <svg class="w-4 h-4 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        </a>
        ...
        <div x-show="currentSlide === 2" 
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 w-full">
                <div class="max-w-xl space-y-6">
                    ...
                    <div class="flex flex-wrap items-center gap-4 pt-2">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Building Metal Structure')"
                           class="inline-flex items-center justify-center gap-2 bg-slate-900 hover:bg-[#FF8B02] text-white font-extrabold px-8 py-3.5 rounded-full shadow-lg transition-all text-sm transform hover:-translate-y-0.5">
                            Learn More
                            <svg class="w-4 h-4 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                        </a>
    ...
    <!-- 2. CATEGORIZED PRODUCTS SECTION (FULL SIZE IMAGE CARDS) -->
    <section id="categories" class="py-20 sm:py-28 bg-slate-50 text-slate-900 relative border-b border-slate-200">
        
        <div class="absolute top-0 right-0 w-96 h-96 bg-gradient-to-br from-[#FF8B02]/10 via-orange-100/30 to-transparent blur-3xl pointer-events-none rounded-full"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-gradient-to-tr from-[#FF8B02]/10 via-orange-100/30 to-transparent blur-3xl pointer-events-none rounded-full"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="text-center max-w-3xl mx-auto mb-16 space-y-4">
                ...
                <h2 class="text-3xl sm:text-4xl lg:text-5xl font-black text-slate-900 uppercase tracking-tight leading-tight">
            ...
            <!-- 6 Cards with FULL-SIZE Edge-to-Edge Top Images -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10">
                ...
                <div class="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-md hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2 text-xs sm:text-sm text-slate-600 font-medium">
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab Cottage House')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefabricated Modular Cottage')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    ...
                    <div class="p-6 pt-0">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefab Houses')" 
                ...
                <div class="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-md hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2 text-xs sm:text-sm text-slate-600 font-medium">
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab Double Story Buildings')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Pre fabricated Stall')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    ...
                    <div class="p-6 pt-0">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefab Structures')" 
                           class="w-full bg-[#FFF4E5] hover:bg-[#FF8B02] text-[#FF8B02] hover:text-white font-extrabold text-xs py-3.5 rounded-2xl border border-[#FFD199] shadow-xs flex items-center justify-center gap-1.5 transition-all">
                ...
                <div class="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-md hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2 text-xs sm:text-sm text-slate-600 font-medium">
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefabricated School Building')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Roof Top Buildings')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Roof Top Buildings
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab School Building')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    ...
                    <div class="p-6 pt-0">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefab Buildings')" 
                           class="w-full bg-[#FFF4E5] hover:bg-[#FF8B02] text-[#FF8B02] hover:text-white font-extrabold text-xs py-3.5 rounded-2xl border border-[#FFD199] shadow-xs flex items-center justify-center gap-1.5 transition-all">
                ...
                <div class="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-md hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2 text-xs sm:text-sm text-slate-600 font-medium">
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab Site Office')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Prefab Site Office
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefabricated Classroom Structure')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Pre Fabricated Building')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    ...
                    <div class="p-6 pt-0">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefebricated Offices')" 
                           class="w-full bg-[#FFF4E5] hover:bg-[#FF8B02] text-[#FF8B02] hover:text-white font-extrabold text-xs py-3.5 rounded-2xl border border-[#FFD199] shadow-xs flex items-center justify-center gap-1.5 transition-all">
                ...
                <div class="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-md hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2 text-xs sm:text-sm text-slate-600 font-medium">
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefabricated Cottage Homes')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab Bunk House')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Prefab Bunk House
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefabricated Portable Cabin')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    ...
                    <div class="p-6 pt-0">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Prefab Cabins')" 
                           class="w-full bg-[#FFF4E5] hover:bg-[#FF8B02] text-[#FF8B02] hover:text-white font-extrabold text-xs py-3.5 rounded-2xl border border-[#FFD199] shadow-xs flex items-center justify-center gap-1.5 transition-all">
                ...
                <div class="bg-white rounded-3xl border border-slate-200/90 overflow-hidden shadow-md hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                    <div>
                        ...
                        <div class="p-6 space-y-4">
                            ...
                            <ul class="space-y-2 text-xs sm:text-sm text-slate-600 font-medium">
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab Labour Room')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Prefab Labour Room
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Prefab Labour Camp')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                                            Prefab Labour Camp
                                ...
                                <li>
                                    <a href="#contact" 
                                       wire:click="selectProductForEnquiry('Portable Labour Rooms')" 
                                       class="flex items-center justify-between p-2 rounded-xl hover:bg-[#FFF4E5] hover:text-[#FF8B02] transition-all group/link">
                                        <span class="flex items-center gap-2">
                                            <svg class="w-3.5 h-3.5 text-[#FF8B02]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7"/></svg>
                    ...
                    <div class="p-6 pt-0">
                        <a href="#contact" 
                           wire:click="selectProductForEnquiry('Labour Hutments')" 
                           class="w-full bg-[#FFF4E5] hover:bg-[#FF8B02] text-[#FF8B02] hover:text-white font-extrabold text-xs py-3.5 rounded-2xl border border-[#FFD199] shadow-xs flex items-center justify-center gap-1.5 transition-all">
    ...
    <section id="why-us" class="py-16 sm:py-24 bg-white text-slate-900 border-b border-slate-200 relative">
    ...
    <!-- 4. AUTO-SLIDING TESTIMONIALS SECTION (3 CARDS VISIBLE ON DESKTOP) -->
    <section id="testimonials" 
        ...
        <div class="absolute top-1/2 left-0 -translate-y-1/2 w-96 h-96 bg-[#FF8B02]/10 blur-3xl pointer-events-none rounded-full"></div>
        <div class="absolute top-1/2 right-0 -translate-y-1/2 w-96 h-96 bg-[#FF8B02]/10 blur-3xl pointer-events-none rounded-full"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <!-- Testimonial Grid Viewport (3 Cards Visible on Desktop) -->
            <div class="relative">
                    ...
                    <div class="bg-white rounded-3xl p-7 border border-slate-200 shadow-sm hover:shadow-2xl hover:border-[#FF8B02]/50 transition-all duration-500 flex flex-col justify-between group">
                        <div class="space-y-4">
                            ...
                            <p class="text-slate-700 text-sm font-semibold leading-relaxed italic">
                                "Shallom delivered our 15,000 sq. ft. modular site office complex in 5 days! The thermal insulation during Delhi summers keeps inside temperatures cool, drastically cutting HVAC costs."
                            </p>
                        </div>

                        <div class="flex items-center gap-3.5 pt-5 border-t border-slate-100 mt-6">
                            <div class="w-11 h-11 rounded-full bg-[#FFF4E5] border border-[#FFD199] flex items-center justify-center text-[#FF8B02] font-black text-sm shrink-0">
                                SV
                            </div>
                            <div>
                ...
                <div class="flex items-center justify-center gap-2 mt-10">
                    <template x-for="(p, index) in totalPages" :key="index">
                        <button @click="page = index" 
                                :class="page === index ? 'w-8 bg-[#FF8B02]' : 'w-2.5 bg-slate-300 hover:bg-slate-400'"
                                class="h-2.5 rounded-full transition-all duration-300 focus:outline-none"
    ...
    <!-- 5. RELATABLE FAQ ACCORDION SECTION -->
    <section id="faq" 
             x-data="{ openFaq: 0 }" 
