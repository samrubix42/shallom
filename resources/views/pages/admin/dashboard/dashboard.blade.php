<div class="space-y-8">
    ...
    <div class="bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-xs flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-3 shrink-0">
            <a href="{{ route('products') }}" wire:navigate class="inline-flex items-center gap-2 bg-[#FAF9F5] hover:bg-[#FFF4E5] text-slate-800 hover:text-[#FF8B02] font-bold px-5 py-3 rounded-2xl border border-slate-200/80 text-xs uppercase tracking-wider transition-all">
                <i class="ri-ruler-2-line"></i>
                <span>Catalog Specs</span>
            </a>
            <a href="{{ route('contact') }}" wire:navigate class="inline-flex items-center gap-2 bg-[#FF8B02] hover:bg-[#E67A00] text-white font-extrabold px-6 py-3 rounded-2xl shadow-md shadow-orange-500/20 text-xs uppercase tracking-wider transition-all">
    ...
    <!-- 3. RECENT BOQ ENQUIRIES TABLE & FACTSHEET CARD -->
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        
        <!-- Left 8 Cols: Recent BOQ Requests Table -->
        ...
        <!-- Right 4 Cols: Quick Company Factsheet Card -->
        <div class="lg:col-span-4 bg-slate-900 text-white rounded-3xl p-6 shadow-2xl space-y-6 relative overflow-hidden">
            <div class="space-y-1 relative z-10">
                ...
                <h3 class="text-xl font-bold">Shallom Prefab Systems</h3>
            </div>

            <div class="space-y-3 text-xs text-slate-300 font-medium relative z-10">
                <div class="flex items-center justify-between py-2 border-b border-slate-800">
                    <span class="text-slate-400">Proprietor:</span>
                    <span class="font-bold text-white">Mr. Arvind Kumar Gautam</span>
                </div>
                <div class="flex items-center justify-between py-2 border-b border-slate-800">
                    <span class="text-slate-400">Annual Turnover:</span>
                    <span class="font-bold text-white">₹5 Crore – ₹25 Crore</span>
                </div>
                <div class="flex items-center justify-between py-2 border-b border-slate-800">
                    <span class="text-slate-400">Team Strength:</span>
                    <span class="font-bold text-white">26 – 50 Professionals</span>
                </div>
                <div class="flex items-center justify-between py-2 border-b border-slate-800">
                ...
                <div class="flex items-center justify-between py-2 border-b border-slate-800">
                    <span class="text-slate-400">Primary Banker:</span>
                    <span class="font-bold text-white">AXIS BANK</span>
                </div>
            </div>

            <div class="pt-2 relative z-10">
                <a href="{{ route('profile') }}" wire:navigate class="w-full inline-flex items-center justify-center gap-2 bg-[#FF8B02] hover:bg-[#E67A00] text-white font-extrabold py-3 rounded-2xl text-xs uppercase tracking-wider transition-colors shadow-md">
