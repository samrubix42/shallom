...
new #[Layout('layouts::app')] #[Title('Product Catalog & Specifications | Shallom Prefab Systems')] class extends Component {
    ...
    public array $products = [
        [
            ...
            'specs' => [
                'Material' => 'Wood / PUF Sandwich Panels / Steel Framework',
                ...
                'Available Material' => 'Insulated Panels, CFB, GB, PUF Insulation, Structural Steels',
            ],
            'description' => 'Leveraging our vast engineering experience in this domain, we are providing premium Prefabricated Portable House structures. The offered product is fabricated using finest quality structural steel framing and weather-resistant insulated sandwich wall panels.',
        ],
        [
            ...
            'specs' => [
                'Material' => 'Galvanized Steel Frame & EPS Insulation Panels',
            ...
            'description' => 'Heavy-duty plug-and-play executive site office cabin designed for rapid deployment at infrastructure and construction projects. Features pre-wired electrical sockets, LED lighting, and thermal wall insulation.',
        ],
        [
            ...
            'description' => 'High-span structural steel framework manufactured according to structural load drawings. Perfect for factory sheds, warehouse facilities, and rooftop industrial floor extensions.',
        ],
        [
            ...
            'specs' => [
                'Material' => 'Corrugated Sheet / Cement Fibre Board / Steel Frame',
