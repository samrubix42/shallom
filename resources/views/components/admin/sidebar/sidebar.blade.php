<aside class="w-64 bg-white text-slate-800 flex flex-col shrink-0 border-r border-slate-200/80 h-full">
    ...
    <div class="flex-1 px-3 py-4 space-y-6 overflow-y-auto">
        ...
        <div class="space-y-1">
            ...
            <a href="{{ route('admin.contacts') }}" wire:navigate 
               class="flex items-center gap-2.5 px-3 py-2 rounded-md text-xs font-semibold transition-colors {{ request()->routeIs('admin.contacts') ? 'bg-[#FFF4E5] text-[#FF8B02] border border-[#FFD199]' : 'text-slate-600 hover:bg-[#FAF9F5] hover:text-slate-900' }}">
                <i class="ri-mail-line text-sm text-[#FF8B02]"></i>
