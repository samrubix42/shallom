<footer class="bg-slate-50 text-slate-700 pt-16 pb-8 border-t border-slate-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <!-- Top Callout Banner (Clean Light Theme with #FF8B02) -->
        <div class="bg-white rounded-3xl p-8 mb-16 border border-slate-200 shadow-lg relative overflow-hidden flex flex-col md:flex-row items-center justify-between gap-6">
            <div class="relative z-10 max-w-xl">
                <span class="text-[#FF8B02] text-xs font-extrabold uppercase tracking-widest bg-[#FFF4E5] px-3.5 py-1.5 rounded-full border border-[#FFD199]">
                    Ready for Modular Construction?
                </span>
                <h3 class="text-2xl sm:text-3xl font-extrabold text-slate-900 mt-3">Get Custom Quotation For Your Prefab Project Today</h3>
                <p class="text-slate-600 text-sm mt-2 font-medium">Whether you need site offices, labor colonies, modular cottages, or industrial steel sheds — our engineering team delivers in record turnaround.</p>
            </div>
            <div class="relative z-10 flex flex-col sm:flex-row gap-3 w-full md:w-auto shrink-0">
                <a href="tel:+917942550323" 
                   class="inline-flex justify-center items-center gap-2 bg-[#FF8B02] hover:bg-[#E67A00] text-white font-extrabold px-6 py-3.5 rounded-full shadow-md shadow-orange-500/20 transition-all text-sm">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                    Call 07942550323
                </a>
                <a href="#contact" 
                   class="inline-flex justify-center items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white font-bold px-6 py-3.5 rounded-full transition-all text-sm">
                    Submit Requirements
                </a>
            </div>
        </div>
