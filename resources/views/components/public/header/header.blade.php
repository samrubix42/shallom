<header x-data="{ mobileMenuOpen: false }" class="sticky top-0 z-50 bg-white/95 backdrop-blur-md text-slate-900 border-b border-slate-200/80 shadow-xs transition-all duration-300">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="flex items-center justify-between h-20 sm:h-22">
            ...
            <nav class="hidden lg:flex items-center justify-center gap-7 text-xs font-bold uppercase tracking-wider text-slate-600 absolute left-1/2 -translate-x-1/2">
                ...
                <a href="#testimonials" class="hover:text-[#FF8B02] transition-colors py-1">
                    Reviews
                </a>
                <a href="#faq" class="hover:text-[#FF8B02] transition-colors py-1">
                    FAQ
                </a>
                <a href="#contact" class="hover:text-[#FF8B02] transition-colors py-1">
                    Contact
                </a>
            </nav>
    ...
    <div x-show="mobileMenuOpen" 
        ...
        <a href="#hero" @click="mobileMenuOpen = false" class="block py-2 text-[#FF8B02] font-extrabold text-sm">Home</a>
        <a href="#categories" @click="mobileMenuOpen = false" class="block py-2 text-slate-700 hover:text-[#FF8B02] font-semibold text-sm">Products</a>
        <a href="#why-us" @click="mobileMenuOpen = false" class="block py-2 text-slate-700 hover:text-[#FF8B02] font-semibold text-sm">Why Choose Us</a>
        <a href="#testimonials" @click="mobileMenuOpen = false" class="block py-2 text-slate-700 hover:text-[#FF8B02] font-semibold text-sm">Reviews</a>
        <a href="#faq" @click="mobileMenuOpen = false" class="block py-2 text-slate-700 hover:text-[#FF8B02] font-semibold text-sm">FAQ</a>
        <a href="#contact" @click="mobileMenuOpen = false" class="block py-2 text-slate-700 hover:text-[#FF8B02] font-semibold text-sm">Contact</a>
